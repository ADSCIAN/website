...
| &nbsp;                 | &nbsp; | &nbsp;                                                                   |
|------------------------|--------|--------------------------------------------------------------------------|
| **Name**               | &nbsp; | AD Scientific Consulting & Environmental Systems Analytics (ADSCIAN SRL) |
| **Registered Address** | &nbsp; | Av. du Paepedelle 65, 1160, Brussels, Belgium                            |
| **VAT Number**         | &nbsp; | BE 0772.850.171                                                          |
| **Contact Details**    | &nbsp; | contact@adscian.be                                                       |

Hereafter, ADSCIAN.

### Content and Intellectual Property

* The ADSCIAN website is a static website generated
  using [HUGO](https://gohugo.io/) and
  the [Andromeda](https://docs.gethugothemes.com/andromeda/) template, provided
  by [Gethugothemes](https://gethugothemes.com/);
* The icons that are not hosted are provided
  by [Line Awesome](https://icons8.com/line-awesome) under their terms of use;

**Earth Observation Images**

* The page header images are sourced from
  the [NASA Earth Observatory—Image of the Day Collection](https://science.nasa.gov/earth/earth-observatory/image-of-the-day/)
  and copyrighted by their respective owners.
* Front page:
  [A Blackwater River Meets the Sea](https://science.nasa.gov/earth/earth-observatory/a-blackwater-river-meets-the-sea-144147/).
  Instrument: _Landsat 8-OLI_. Credit: _NASA Earth Observatory image by Dr.
  Alice Alonso, using Landsat data from the U.S. Geological Survey. Story by 
  Laura Rocchio, NASA Landsat Science Outreach_.
* Legal information:
...
* Projects:
  ...
  Credit: _NASA Earth Observatory images by Michala Garrison, using Landsat data
...
Unless specified otherwise, all other content, including texts, graphics, logos,
and images on this website, is the property of ADSCIAN and is protected by
copyright laws. Unauthorized use, reproduction, or distribution of the content
...
ADSCIAN reserves the right to make changes to the content at any time without
notice.

### No Cookies Policy

Our website is static and does not use any cookies or third-party services.
Therefore, we do not collect or store any personal data from our visitors unless
they choose to contact us directly.

### Contact

If you have any questions or concerns regarding these terms or any content on
our website, please contact us
at [contact@adscian.com](mailto:contact@adscian.com).
