...
about_us:
    ...
    text: "With research backgrounds from UCLouvain (Belgium) and the University of Florida (USA), we recognized a gap in transferring academic expertise to address natural resource management and climate challenges. ADSCIAN's mission is to bridge this gap, ensuring that the latest academic discoveries benefit a broader audience. By collaborating closely with the academic community, we stay current with the newest research, methods, and tools. We are committed to excellence and transparency. Our promise to clients is a partnership that delivers solutions tailored to their unique needs."
    cards:
...
adscian_origin:
  question: 'Do you wonder what <span style="color: #06a6a1;">ADSCIAN</span> stands for?'
  answer: 'ADSCIAN is the acronym for <strong style="font-weight: bold;">AD
          Scientific consulting and Environmental
          Systems Analytics</strong>.
          AD are our common initials, and we like it because “ad” means
          “towards” in Latin, which reflects our mission
          to support our customer work towards more impact. SCI is for science;
          AN is for analytics, et voilà: ADSCIAN!'
