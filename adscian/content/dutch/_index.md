...
about_us:
  title: "Over ons"
  subtitle: "Onze technische expertise dekt de gebieden van **hydrologie**, **milieuwetenschappen** en **data-analyse**."
  text: "Met een academische achtergrond van UCLouvain (België) en de University of Florida (VS) hebben we een kloof herkend in het benutten van academische expertise om uitdagingen met betrekking tot het beheer van natuurlijke hulpbronnen en klimaat aan te pakken. De missie van ADSCIAN is om deze kloof te overbruggen, zodat de nieuwste academische ontdekkingen een breder publiek ten goede komen. Door nauwe samenwerking met de academische gemeenschap blijven we op de hoogte van het nieuwste onderzoek, methoden en tools. Wij zetten ons in voor uitmuntendheid en transparantie. Wij beloven onze klanten een partnerschap dat oplossingen biedt die zijn afgestemd op hun unieke behoeften."
  cards:
    -   name: Alice Alonso, PhD
        desc: Medeoprichter & Partner
...
adscian_origin:
  question: 'Vraag je je af waar <span style="color: #06a6a1;">ADSCIAN</span> voor staat?'
  answer: 'ADSCIAN is het acroniem voor <strong style="font-weight: bold;">AD
          Scientific consulting and Environmental
          Systems Analytics</strong>.
          AD zijn onze gemeenschappelijke initialen, en we houden ervan omdat “ad” in het Latijn
          “richting” betekent, wat onze missie weerspiegelt
          om onze klanten te ondersteunen bij het werken richting meer impact. SCI staat voor science;
          AN staat voor analytics, et voilà: ADSCIAN!'
---
